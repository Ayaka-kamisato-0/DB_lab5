<template>
    ...
    <!-- 标题和搜索框 -->
    <div style="margin-top: 20px; margin-left: 40px; font-size:
    2em; font-weight: bold; ">图书管理
    <el-input v-model="toSearch" :prefix-icon="Search"
    style=" width: 15vw;min-width: 150px; margin-left:
    30px; margin-right: 30px; float: right;" clearable />
    </div>
    <div style="margin-top: 20px; margin-left: 40px; font-size:
    ...
    <el-button type="primary" @click="triggerFileInput">选择文件
    批量上传</el-button>
    </div>
    <div style="margin-top: 20px; margin-left: 40px; font-size:
    2em; font-weight: bold; ">
    <!-- Element UI 的按钮，点击时触发 -->
    <el-button type="primary" @click="SiftVisible = true">图书筛
选查看</el-button>
</div>
<!-- 图书卡片显示区 -->
...
<div>
<!-- 卡片标题 -->
<div style="font-size: 25px; font-weight: bold;">No. {{
book.bookId }}</div>
<el-divider />
<!-- 卡片内容 -->
...
@click="newBookInfo.title = '',
newBookInfo.category = '', newBookInfo.press = '',
newBookInfo.publishYear = '', newBookInfo.author
= '', newBookInfo.price = '', newBookInfo.stock = '',
newBookVisible = true">
...
<!-- 新建借书对话框 -->
<el-dialog v-model="newBorrowVisible" title="借/还书申请"
width="30%" align-center>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
借书证号：
<el-input v-model="Toborrow.cardId" style="width: 12.5vw;"
clearable />
</div>
<template #footer>
<span>
<el-button @click="newBorrowVisible = false">
取消</el-button>
<el-button type="primary" @click="ConfirmReturn"
:disabled="Toborrow.cardId.length ===
0">确定还书</el-button>
...
<!-- 新建筛选卡片 -->
<el-dialog v-model="SiftVisible" title="筛选图书面板"
width="30%" align-center>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
书名：
<el-input v-model="condition.title" style="width: 12.5vw;"
clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
风格：
<el-input v-model="condition.category" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
作者：
<el-input v-model="condition.author" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
出版社：
<el-input v-model="condition.press" style="width: 12.5vw;"
clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
最低价格：
<el-input v-model="condition.minPrice" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
最高价格：
<el-input v-model="condition.maxPrice" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
查询年份起始：
<el-input v-model="condition.minPublishYear" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
查询年份终止：
<el-input v-model="condition.maxPublishYear" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size: 1rem; margin-top: 20px; ">
排序关键词：
<el-select v-model="condition.sortBy" size="default"
style="width: 12.5vw;">
<el-option v-for="type in stbytypes" :key="type.value"
:label="type.label" :value="type.value" />
</el-select>
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size: 1rem; margin-top: 20px; ">
排序方式：
<el-select v-model="condition.sortOrder" size="default"
style="width: 12.5vw;">
<el-option v-for="type in stodtypes" :key="type.value"
:label="type.label" :value="type.value" />
</el-select>
</div>
<template #footer>
<span>
<el-button @click="SiftVisible = false">取消
</el-button>
<el-button type="primary" @click="QueryBooks">
确定</el-button>
   </span>
</template>
</el-dialog>
<!-- 新建图书对话框 -->
<el-dialog v-model="newBookVisible" title="新建图书"
width="30%" align-center>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
书名：
<el-input v-model="newBookInfo.title" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
...
1rem; margin-top: 20px; ">
作者：
<el-input v-model="newBookInfo.author" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
出版年份：
<el-input v-model="newBookInfo.publishYear" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
出版社：
<el-input v-model="newBookInfo.press" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
价格：
<el-input v-model="newBookInfo.price" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
库存：
<el-input v-model="newBookInfo.stock" style="width:
12.5vw;" clearable />
</div>
<template #footer>
<span>
<el-button @click="newBookVisible = false">取
消</el-button>
<el-button type="primary"
@click="ConfirmNewBook"
:disabled="newBookInfo.title.length
=== 0 || newBookInfo.price.length === 0">确定</el-button>
</span>
</template>
</el-dialog>
<!-- 修改信息对话框 -->
...
1rem; margin-top: 20px; ">
库存变化(可正可负)：
<el-input v-model="toModifyInfo.deltaStock" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
书名：
<el-input v-model="toModifyInfo.title" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
...
1rem; margin-top: 20px; ">
出版年份：
<el-input v-model="toModifyInfo.publishYear" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
出版社：
<el-input v-model="toModifyInfo.press" style="width:
12.5vw;" clearable />
</div>
<div style="margin-left: 2vw; font-weight: bold; font-size:
1rem; margin-top: 20px; ">
价格：
<el-input v-model="toModifyInfo.price" style="width:
12.5vw;" clearable />
</div>
<template #footer>
<span class="dialog-footer">
<el-button @click="modifyBookVisible = false">
取消</el-button>
<el-button type="primary"
@click="ConfirmModifyBook"
:disabled="toModifyInfo.title.length === 0 ||
toModifyInfo.price.length === 0 ">确定(非库存部分)</el-button>
<el-button type="primary"
@click="ConfirmBookStock"
:disabled="toModifyInfo.title.length
=== 0 || toModifyInfo.price.length === 0 ">确定(库存部分)</el-button>
</span>
</template>
</el-dialog>
<!-- 删除图书对话框 -->
...
width="30%">
<span>确定删除<span style="font-weight: bold;">{{ toRemove }}
号图书</span>吗？</span>
<template #footer>
<span class="dialog-footer">
<el-button @click="removeBookVisible = false">
取消</el-button>
